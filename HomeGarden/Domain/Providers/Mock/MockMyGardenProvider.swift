...
struct MockMyGardenProvider: MyGardenProviding {
    static let plants: [Plant] = [
        .init(id: "1", name: "some plant", imageURL: "1", features: [
        ...
        .init(id: "2", name: "some other plant", imageURL: "2", features: [], description: ""),
        .init(id: "3", name: "some other plant", imageURL: "3", features: [], description: ""),
        .init(id: "4", name: "some other plant", imageURL: "4", features: [], description: ""),
        .init(id: "5", name: "some other plant", imageURL: "5", features: [], description: "")
    ]
